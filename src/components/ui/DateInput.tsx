  ...
  return (
    <div className={`relative ${width}`}>
      <select
        ...
        className="w-full appearance-none bg-base border border-strong rounded text-primary text-sm font-mono px-2 py-0.5 pr-6 outline-none focus:border-accent-primary cursor-pointer"
      >
        {options.map((opt) => (
