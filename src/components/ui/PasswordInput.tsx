  ...
  return (
    <div className="relative group">
      <input
        ...
        aria-label={ariaLabel}
        className={clsx(
          "w-full px-3 py-2 pr-10 bg-base border border-strong rounded-lg text-sm text-primary placeholder:text-muted focus:border-accent-primary focus:outline-none transition-colors",
          className,
        )}
      />
      <button
