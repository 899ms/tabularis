    ...
    return (
      <div className="flex flex-col gap-2 h-full min-h-0">
        {!externalSearchProvided && (
          <div className="flex items-center gap-2 bg-base border border-strong rounded px-2 py-1.5 focus-within:border-accent-primary transition-colors flex-shrink-0">
