      ...
      <EdgeLabelRenderer>
        ...
        >
          <button
            ...
            className="bg-surface-secondary border border-strong rounded px-2 py-1 text-xs font-medium text-accent-primary hover:bg-surface-tertiary hover:border-accent-primary transition-all shadow-lg"
          >
            {joinType}
          </button>
        </div>
