        ...
        <div className="flex items-center justify-between p-4 border-b border-default bg-base">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-accent-primary/15 rounded-lg">
              <Library size={20} className="text-accent-primary" />
            </div>
            <div>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <button
                          ...
                          className="p-2 text-secondary hover:text-accent-primary hover:bg-surface-secondary rounded-lg transition-colors"
