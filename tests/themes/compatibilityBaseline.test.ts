...
import builtinGolden from "../fixtures/themes/builtin-rendering.json";
import assetGolden from "../fixtures/themes/named-editor-assets.json";
import legacyFrontend from "../fixtures/themes/legacy-frontend.json";
